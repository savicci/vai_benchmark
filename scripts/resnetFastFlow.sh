...
python ../train/resnet_custom_train.py --batch_size 32 --epochs 10 --workspace $WORKSPACE --prefix $PREFIX

# setup for pruning
# prune network
conda activate vitis-ai-optimizer_tensorflow2
export XILINXD_LICENSE_FILE=/workspace/vai_optimizer.lic
python ../pruning/resnet_custom_prune.py --batch_size 32 --epochs 2 --workspace $WORKSPACE --prefix $PREFIX --ratio $RATIO
