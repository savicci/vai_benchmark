...
def app(batch_size, epochs, path, model_path):
    ...
    quantized_model_no_ft = no_ft_quantizer.quantize_model(calib_dataset=ds_test, calib_steps=10, calib_batch_size=10,
                                                     include_fast_ft=False)
    # quantize with fine-tuning
    print("Start quantizing ft")
    quantized_model_ft = ft_quantizer.quantize_model(calib_dataset=ds_test, calib_steps=10, calib_batch_size=10,
