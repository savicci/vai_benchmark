...
quantized_model = quantizer.quantize_model(calib_dataset=ds_train, calib_steps=100, calib_batch_size=10, include_fast_ft=True, fast_ft_epochs=10)
...
with open('/workspace/vai_benchmark/data/results/ptq_ft_fmnist.txt', 'w') as f:
    with redirect_stdout(f):
        print('Float model evaluation results', float_res)
        print('Quantized model with ft evaluation results', quant_res)